...
//Audio elements
var playanimation = true; //variable will be turned false whenever the user scrolls past the animation canvas
...
const draw = () => {
    //Check if the user is within range for the audio to be played
    ...
    else if (time == 45){ //delay to easen transition between animation repetitions
        time=0
    }
}
